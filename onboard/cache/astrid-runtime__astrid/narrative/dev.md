...
Conséquence pratique : un seul relecteur pour vos PR ; 24 PR ouvertes, 24 en attente de revue [facts:pulls.open] [facts:pulls.awaiting_review].
...
5 issues `good first issue` [facts:issues.by_label.good first issue] sur 192 ouvertes [facts:issues.open] (149 fermées en 30 jours [facts:issues.closed_30d], 42 étiquetées `bug` [facts:issues.by_label.bug]) :
