...
> Astrid, c'est une maison où chaque petit programme a sa chambre fermée à clé : sans la clé, il ne peut pas entrer chez les autres [src:readme.md].
...
> C'est un gâteau fait presque tout seul par un pâtissier : si joshuajbouw s'arrête, le projet s'arrête presque [facts:activity.bus_factor].
...
> On range le code dans un grand classeur, on discute avant de changer, et des robots vérifient chaque changement comme à la sortie d'une usine de jouets [facts:tree.4.role] [src:readme.md].
...
> Né le 15 février 2026, Astrid a déjà 10277 étoiles : un petit nouveau qui s'est fait plein d'amis en quelques mois [facts:repo.created_at] [facts:repo.stars].

## Et toi, tu ferais quoi avec ?
- Lui écrire une phrase, comme « résume ce qui a changé », et le laisser faire le travail à ta place [src:readme.md].
- Fabriquer ta propre petite chambre de la maison, une « capsule » : le mode d'emploi montre l'exemple d'une capsule qui donne la météo d'une ville [src:readme.md].
- Créer un robot-assistant qui n'a le droit d'ouvrir qu'un seul tiroir de ton ordinateur, avec une mémoire limitée, comme un argent de poche [src:readme.md].
