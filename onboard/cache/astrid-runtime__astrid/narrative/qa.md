...
> 39 fichiers de test relevés entre `crates/astrid-integration-tests`, `crates/astrid-test` et `e2e/` (cargo test + snapshots insta), mais aucun taux de couverture dans le cache [facts:tests.files] [facts:tests.framework] [src:tests.md].
